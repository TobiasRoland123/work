      ...
      <div className="px-3 pt-4 pb-7">
        <div className="flex justify-between">
          <div className="flex flex-col items-start gap-2">
            <Skeleton className="w-[19ch] text-base h-5 rounded-full" /> {/* Text label */}
            ...
            <div className="flex items-center gap-3 px-2 py-1 pb-3 border-gray-400">
              ...
              <div className="flex flex-col gap-3.5 w-full min-w-0 pt-1">
                ...
                <div className="flex flex-wrap gap-2">
                  <Skeleton className="w-[10ch] h-6 text-24 rounded-full" />
                  <Skeleton className="w-[12ch] h-6 text-24 rounded-full" />
                </div>
                <div className="flex flex-wrap items-center gap-2">
                  {/* Title */}
                  <Skeleton className="w-[20ch] text-base h-4 rounded-full" />
                  {/* Status */}
                  <Skeleton className="w-[10ch] text-base h-4 rounded-full" />
                </div>
